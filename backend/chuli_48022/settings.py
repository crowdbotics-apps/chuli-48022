"""
Django settings for chuli_48022 project.
...
WSGI_APPLICATION = 'chuli_48022.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "chuli_48022 API",
    "DESCRIPTION": "API documentation for chuli_48022 App",
    "VERSION": "v1",
}
